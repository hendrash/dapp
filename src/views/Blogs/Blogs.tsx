...
const Blogs: React.FC = () => {
  return (
    <div className="margins">
      ...
      <p>
        Reentry Attack is a greedy exploit that can be exploited completely
        draining a smart contract of all its ether. Reentry attack can occur
        when a contract does internal count with a balance variable and exposes
        the withdraw function. The vulnerability can occur if the contract
        transfers funds before it sets its balance to zero. This allows the
        attacker to repeatedly call the withdraw function until the contract is
        completely drained. This is possible because of solidity’s asynchronous
        nature. All the attacker needs is the balance amount mapped to the
        victim’s contract and the withdraw function to be exposed.
      </p>
      <div>
...
<div>
      ...
      <br/><br/>
        <p>
          ...
          of a victim contract, It's important to point out that contracts
          should never trust external contract calls to execute without throwing
          an error.
        </p>
      </div>
  );
